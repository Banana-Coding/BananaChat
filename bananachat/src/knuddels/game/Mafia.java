			...
			synchronized (players) {
				if (players.size() < 5) {
					channel.broadcastButlerMessage(String
							.format("Noch können wir leider nicht anfangen. Wir haben _erst %s Spieler_, brauchen aber _mindestens 5 Spieler_. Wer kein Angsthase ist, meldet sich bei mir °R°privat°°.",
									players.size()));
					status++;
				} else {
					status = 3;
